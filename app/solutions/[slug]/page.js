...
export default function SolutionPage() {
  ...
  const lead = useLead()
  const page = SITE_PAGES.solutions?.[slug]
  if (!page) return (
    <main className="min-h-screen bg-white">
      <Nav openLead={lead.open} />
      <div className="pt-40 pb-24 text-center"><div className="text-8xl font-display font-bold text-brand mb-4">404</div><h1 className="font-display text-3xl font-bold text-slate-900">Solution not found</h1></div>
