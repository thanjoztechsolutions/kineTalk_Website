    ...
    Products: {
      cols: [
        { title: 'CHAT SDK', items: [
          { i: MessageSquare, t: 'In-App Chat', d: 'Realtime 1:1 & group messaging.', href: '/products/chat-sdk' },
          { i: Hash, t: 'Channels & Threads', d: 'Public and private channels.', href: '/products/chat-sdk' },
          { i: Bell, t: 'Push Notifications', d: 'Rich, deliverable notifications.', href: '/products/chat-sdk' },
          { i: Paperclip, t: 'Media & File Sharing', d: 'Images, videos, files up to 100MB.', href: '/products/chat-sdk' },
        ]},
        { title: 'CALL SDK', items: [
          { i: Phone, t: 'Voice Calls', d: 'HD 1:1 and group voice calling.', href: '/products/call-sdk' },
          { i: Video, t: 'Video Calls', d: 'Up to 1000 participants.', href: '/products/call-sdk' },
          { i: Share2, t: 'Screen Sharing', d: 'Share screen with annotations.', href: '/products/call-sdk' },
          { i: PhoneForwarded, t: 'SIP & VoIP', d: 'Bridge to PSTN and SIP trunks.', href: '/products/sip-voip' },
        ]},
      ],
    },
    'Enterprise IM': {
      cols: [{ title: 'ENTERPRISE MESSAGING', items: [
        { i: Users, t: 'Team Collaboration', d: 'Slack-style workspace with huddles.', href: '/products/enterprise-im' },
        { i: ShieldCheck, t: 'Compliance & Audit', d: 'Retention, eDiscovery, SSO/SCIM.', href: '/products/enterprise-im' },
        { i: Server, t: 'Self-Hosted Option', d: 'Kubernetes-native deployment.', href: '/products/on-premise-deployment' },
        { i: Lock, t: 'End-to-End Encryption', d: 'AES-256 with optional BYOK.', href: '/products/enterprise-im' },
      ]}],
    },
    Solutions: {
      cols: [
        { title: 'BY INDUSTRY', items: [
          { i: HeartPulse, t: 'Healthcare', d: 'Telemedicine and patient chat.', href: '/solutions/healthcare' },
          { i: Landmark, t: 'FinTech & Banking', d: 'KYC video and secure chat.', href: '/solutions/fintech-banking' },
          { i: GraduationCap, t: 'Education', d: 'Live classes and communities.', href: '/solutions/education' },
          { i: ShoppingBag, t: 'E-Commerce', d: 'Live shopping and seller chat.', href: '/solutions/ecommerce' },
        ]},
        { title: 'BY USE CASE', items: [
          { i: Headphones, t: 'Customer Support', d: 'Omnichannel support workflows.', href: '/solutions/customer-support' },
          { i: Building2, t: 'Enterprise Comms', d: 'Secure internal chat and calls.', href: '/solutions/enterprise-comms' },
          { i: Gamepad2, t: 'Gaming & Social', d: 'Voice rooms and guild chat.', href: '/solutions/gaming-social' },
          { i: Truck, t: 'Logistics & Dispatch', d: 'Driver chat and status calls.', href: '/solutions/logistics' },
        ]},
      ],
    },
    Developers: {
      cols: [
        { title: 'SDK PLATFORMS', items: [
          { i: Smartphone, t: 'iOS · Swift', d: 'Native SwiftUI and UIKit SDK.', href: '/developers/ios-sdk' },
          { i: Smartphone, t: 'Android · Kotlin', d: 'Jetpack Compose ready.', href: '/developers/android-sdk' },
          { i: Code2, t: 'Flutter', d: 'Cross-platform plugin.', href: '/developers/flutter' },
          { i: Code2, t: 'React Native', d: 'Turbo-module SDK.', href: '/developers/react-native' },
        ]},
        { title: 'WEB & BACKEND', items: [
          { i: Code2, t: 'JavaScript / React', d: 'Framework-agnostic core.', href: '/developers/javascript-react' },
          { i: Code2, t: 'Angular / Vue', d: 'First-class integrations.', href: '/developers/angular-vue' },
          { i: FileText, t: 'REST & WebSocket APIs', d: 'Language-agnostic HTTP + WS.', href: '/developers/api-reference' },
          { i: FileText, t: 'Documentation', d: 'Guides and code samples.', href: '/developers/documentation' },
        ]},
      ],
    },
    Features: {
...
export function Footer() {
  const cols = [
    { t: 'PRODUCTS', links: [
      { t: 'Chat SDK', href: '/products/chat-sdk' },
      { t: 'Call SDK', href: '/products/call-sdk' },
      { t: 'SIP & VoIP', href: '/products/sip-voip' },
      { t: 'Live Streaming', href: '/products/live-streaming' },
      { t: 'Enterprise IM', href: '/products/enterprise-im' },
      { t: 'On-Premise Deployment', href: '/products/on-premise-deployment' },
      { t: 'Multi-Tenant Server', href: '/products/multi-tenant-server' },
    ]},
    { t: 'DEVELOPERS', links: [
      { t: 'Documentation', href: '/developers/documentation' },
      { t: 'API Reference', href: '/developers/api-reference' },
      { t: 'iOS SDK', href: '/developers/ios-sdk' },
      { t: 'Android SDK', href: '/developers/android-sdk' },
      { t: 'Flutter', href: '/developers/flutter' },
      { t: 'React Native', href: '/developers/react-native' },
      { t: 'JavaScript / React', href: '/developers/javascript-react' },
      { t: 'Angular / Vue', href: '/developers/angular-vue' },
      { t: 'Status Page', href: '/developers/status-page' },
      { t: 'Changelog', href: '/developers/changelog' },
    ]},
    { t: 'SOLUTIONS', links: [
      { t: 'Healthcare', href: '/solutions/healthcare' },
      { t: 'FinTech & Banking', href: '/solutions/fintech-banking' },
      { t: 'Education', href: '/solutions/education' },
      { t: 'E-Commerce', href: '/solutions/ecommerce' },
      { t: 'Enterprise Comms', href: '/solutions/enterprise-comms' },
      { t: 'Gaming & Social', href: '/solutions/gaming-social' },
      { t: 'Logistics', href: '/solutions/logistics' },
      { t: 'Customer Support', href: '/solutions/customer-support' },
    ]},
    { t: 'COMPANY', links: [
      { t: 'About KineTalk', href: '/company/about' },
      { t: 'Careers', href: '/company/careers' },
      { t: 'Partners', href: '/company/partners' },
      { t: 'Blog', href: '/company/blog' },
      { t: 'Press Kit', href: '/company/press-kit' },
      { t: 'Contact', href: '/company/contact' },
      { t: 'Terms of Service', href: '/legal/terms' },
      { t: 'Privacy Policy', href: '/legal/privacy' },
      { t: 'Refund Policy', href: '/legal/refund' },
    ]},
  ]
  return (
